...
* **Las Causas (El Doble Golpe):**
    ...
    2.  **⛓️ Falta de Arraigo:** La política de incentivos no actúa como barrera. **En Madrid, casi 2 de cada 3 empleados que abandonan (66%) no poseen Stock Options**, lo que elimina el coste de oportunidad por irse.
...
| **🛠️ Inversión** | **-250.000 € / año** | Coste estimado de refuerzos (horas extra) y plan de Stock Options. |
...
3.  **Nuevo Modelo de Costes:** Oficializar el cálculo del "Coste Real de Rotación" (incluyendo productividad) en los reportes financieros para agilizar la aprobación de presupuestos.
